    ...
    <div class="content container-fluid">
		...
		<ul class="nav nav-tabs menu-tabs">
			...
			<li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url() . 'admin/wallet-payment-gateway'; ?>">Wallet</a>
			</li>
		</ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
							...
							<div class="row mb-4">
								<div class="col">
									<h6 class="card-title mb-0">Wallet</h6>
								</div>
								<div class="col-auto">
									<div class="status-toggle">
										<input class="check" name="wallet_show" type="checkbox"  value="1" id="switch" <?php if($list['status']== 1) { ?>checked <?php } ?>>
