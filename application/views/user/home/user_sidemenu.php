<div class="col-xl-3 col-md-4">
		   		<?php $user_details=$this->db->where('id',$this->session->userdata('id'))->get('users')->row();
		   		if(file_exists($user_details->profile_img)){
		   			$profile_img=$user_details->profile_img;
		   		}else{
				...
				<div class="mb-4">
					<div class="d-sm-flex flex-row flex-wrap text-center text-sm-left align-items-center">
						...
						<div class="ml-sm-3 ml-md-0 ml-lg-3 mt-2 mt-sm-0 mt-md-2 mt-lg-0 info-blk-style">
							...
							<p class="text-muted mb-0"><?php echo (!empty($user_language[$user_selected]['lg_Member_Since'])) ? $user_language[$user_selected]['lg_Member_Since'] : $default_language['en']['lg_Member_Since']; ?> <?php echo date('M Y',strtotime($user_details->created_at));?></p>
						</div>
