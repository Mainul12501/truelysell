					...
					<div class="card">
						...
						<div class="card-body">
                            ...
                            <?php if ($this->session->userdata('role') == 1) { ?>
                                <input type="text" id="api_key" name="api_key" value="<?php if (!empty($list['api_key'])) {echo $list['api_key'];} ?>" class="form-control" placeholder="Enter API Key">
                            <?php } else {
                            	$api_length = strlen($list['api_key']);
                            	$str = str_repeat("x", $api_length-8);
                            	$api_key = "rzp_test_". $str;
                             ?>
                            ...
                            <?php if ($this->session->userdata('role') == 1) { ?>
                                <input type="text" id="value" name="value" value="<?php if (!empty($list['api_secret'])) {echo $list['api_secret'];} ?>" class="form-control" placeholder="Enter Rest Key">
                            <?php } else {
                            ...
                            <?php if ($this->session->userdata('role') == 1) { ?>
                                <input type="text" id="razorpayx_acc_number" name="razorpayx_acc_number" value="<?php if (!empty($list['razorpayx_acc_number'])) {echo $list['razorpayx_acc_number'];} ?>" class="form-control" placeholder="Enter RazorpayX Account number">
                            <?php } else {
                            	$account_length = strlen($list['razorpayx_acc_number']);
			                    $strs = str_repeat("x", $account_length-1);
			                    $rzp_account = "". $strs;
                             ?>
                            	<input type="text" id="razorpayx_acc_number" name="razorpayx_acc_number" value="<?php if (!empty($rzp_account)) {echo $rzp_account;} ?>" class="form-control">
                            <?php } ?>
                            </div>
                            <div class="mt-4">
