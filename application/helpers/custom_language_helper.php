...
if (!function_exists('custom_language')) {
    ...
    function custom_language($u_lng) {
        ...
        $sql = "SELECT lang_value, lang_key, language from language_keywords_management Where language = 'en'";
        ...
        if (!empty($u_lng)) {
            $id = $u_lng;
            $sql = "SELECT lang_value, lang_key, language from language_keywords_management Where language = '" . $id . "'";
            $query = $ci->db->query($sql);
            $row = $query->result_array();
            $user_lang = array();
