                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="post-author1">
                                        <a href="#"><img src="<?php echo  $base_url."/".$profileImage; ?>" alt="<?php echo $posts[0]['full_name']; ?>"> <span>by <?php echo $posts[0]['full_name']; ?> </span></a>
                                    </div>
                                </li>
                        ...
                        <div class="about-author">
                            <div class="about-author-img">
                                <div class="author-img-wrap">
                                    <?php $profileImage = (file_exists($posts[0]['profile_img']))?$posts[0]['profile_img']:'assets/img/user.jpg'; ?>
                                    <a href="#"><img class="img-fluid rounded-circle" alt="" src="<?php echo  $base_url."/".$profileImage; ?>"></a>
                                </div>
                            </div>
                                            ...
                                            <div class="comment">
                                                ...
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                                        <a href="javascript:void(0);" class="blog-author-name"><?php echo $comment['name']; ?> 
                                                        </a>
                                                    </span>
