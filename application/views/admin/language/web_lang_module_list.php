    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">
                        <?php echo(!empty($admin_settings['lg_admin_language_module']))?($admin_settings['lg_admin_language_module']) : 'Modules List';  ?>
                            ...
                            <table class="table table-hover table-center mb-0 language_table" id="language_table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-right">                                        
                                        <a href="<?php echo base_url().'web-language-keywords/'.$page['id'].'?type='.$_GET['type'].'&language='.$_GET['language']; ?>" class="btn btn-sm bg-success-light mr-2">
                                        <i class="far fa-edit mr-1"></i> <?php echo(!empty($admin_settings['lg_admin_keywords_edit']))?($admin_settings['lg_admin_keywords_edit']) : 'Keywords Update';  ?>
                                        </a>
                                    </td>
                                  </tr>
                                <?php } ?>
