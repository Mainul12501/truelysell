...
class Emailtemplate extends CI_Controller{
        ...
        if($this->input->post('form_submit'))
        {
            $this->common_model->checkAdminLogin();
                ...
                if($this->db->insert('email_templates',$data))
                {
                    ...
                    $msgcontent = (!empty($this->data['language_content']['lg_admin_email_templates_addsuccess'])) ? $this->data['language_content']['lg_admin_email_templates_addsuccess'] : 'Email template created successfully.';
    ...
    public function edit($id) 
    {
        ...
        if($this->input->post('form_submit'))
        {
            ...
            {
                $msgcontent = (!empty($this->data['language_content']['lg_admin_email_templates_editsuccess'])) ? $this->data['language_content']['lg_admin_email_templates_editsuccess'] : 'Email template edited successfully.';
        		$message='<div class="alert alert-success text-center fade in" id="flash_succ_message">'.$msgcontent.'</div>';
