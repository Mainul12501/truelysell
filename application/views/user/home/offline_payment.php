...
$subcription_amount = get_gigs_currency($sub_amount['fee'], $sub_amount['currency_code'], $user_currency_code);
?>
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="col-lg-12 col-sm-12 col-12">
					<table class="table">
					    ...
					    <tbody>
					      ...
					      <tr>
					        ...
					        <td><?php echo currency_conversion($user_currency_code).$subcription_amount; ?></td>
					      </tr>
					    </tbody>
					 </table>
					...
					<div class="form-group">
						<label>Document Of Your Payment(jpg,_pdf,_png,_docx)<span class="manidory">*</span></label>
