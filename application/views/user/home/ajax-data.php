				...
				<div class="bookings">
					<div class="booking-list">
						<div class="booking-widget">
							...
							<div class="booking-det-info">
								...
								if ($bookings['status'] == 3) {
									$badge = (!empty($user_language[$user_selected]['lg_complete_res_user'])) ? $user_language[$user_selected]['lg_complete_res_user'] : $default_language['en']['lg_complete_res_user'];
									$class = 'bg-success';
								}
						...
						<div class="booking-action">
							...
							<?php if ($bookings['status']==2) {$pending=0;  if($currentDate <= $bookings['service_date'] ) {?>
								...
								<?php } }elseif($bookings['status']==1){ 
									$pending=$bookings['status'];  if($currentDate <= $bookings['service_date'] ) {?>
