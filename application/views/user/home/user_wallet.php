                                ...
                                <tbody>
                                    ...
                                    if (!empty($wallet_history)) {
                                        foreach ($wallet_history as $key => $value) {
                                            ...
                                            if (!empty($value['credit_wallet'])) {
                                                $color = 'success';
                                                $message = (!empty($user_language[$user_selected]['lg_Credit'])) ? $user_language[$user_selected]['lg_Credit'] : $default_language['en']['lg_Credit'];
                                            } else {
                                                $color = 'danger';
                                                $message = (!empty($user_language[$user_selected]['lg_Debit'])) ? $user_language[$user_selected]['lg_Debit'] : $default_language['en']['lg_Debit'];
                                            }
                                            if (!empty($value["fee_amt"]) && $value["fee_amt"] > 1) {
                                                $txt_amt = number_format($value["fee_amt"] / 100, 2);
                                            } else {
