					...
					<div class="card-body">
						...
						<?php foreach ($lang_test as $langval) {
							...
							<div class="form-group">
                                <label><?php echo(!empty($admin_settings['lg_admin_page_title']))?($admin_settings['lg_admin_page_title']) : 'Page Title';  ?>(<?php echo $langval->language; ?>)<span class="text-danger">*</span> </label>
						...
						<?php foreach ($lang_test as $langval) {
								if($langval->language_value ==  $help['lang_type']) {?>
							<div class="form-group">
                                <label><?php echo(!empty($admin_settings['lg_admin_page_content']))?($admin_settings['lg_admin_page_content']) : 'Page Content';  ?>(<?php echo $langval->language; ?>)<span class="text-danger">*</span></label>
                                <textarea class="form-control" id="editor" name="page_content_<?php echo $langval->id; ?>" required><?php echo ($help['content']) ? $help['content']:''; ?></textarea>
