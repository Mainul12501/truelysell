			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="card-box">
							...
							<div class="form-group cate no-display-new" id="category">
							<div class="form-group">
							...
							<div class="form-group no-display-new" id="quick_link" >
							...
							<div class="form-group sub_menu no-display-new" id="contact_us">
							<div class="form-group sub_menu">
							...
							<div class="form-group sub_menu no-display-new" id="follow_us">
							<div class="form-group sub_menu">
							...
							<div class="form-group sub_menu no-display-new" id="hidey" >
							<div class="form-group sub_menu">
