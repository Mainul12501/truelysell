<?php
	...
	$services = $this->db->where('status',2)->get('services')->result_array();
						...
						<div class="table-responsive">
							<table class="table table-hover table-center mb-0 service_table">
                                ...
                                <tbody>
									...
									echo'<tr>
                                        <td>'.$i++.'</td>
                                        <td><a href="'.base_url().'inactive-service-details/'.$rows['id'].'"><img class="rounded service-img mr-1" src="'.base_url().$ser_image.'" alt=""> '.$service_name.'</a></td>                                       
                                        <td>'.$category_name.'</td>
