      ...
      $.ajax({
        ...
        success: function(response){
          ...
          Swal.fire({
            ...
            html: `<p>Please contact our provider for further informations.</p><p>Provider Name: ${response.provider.name},<br> Phone: <a href="tel:${response.provider.mobileno}">${response.provider.mobileno}</a>, <br> Office Address: ${response.provider_address}</p>`,
            icon: "success",
            button: "okay",
            closeOnEsc: false,
      ...
      success: function(response){
        ...
        if(status == 2){
          ...
          Swal.fire({
            ...
            // title: "Booking Confirmation...",
            // text: "Your booking was booked Successfully ...!",
            html: `<p>Please contact our provider for further informations.</p><p>Provider Name: ${response.provider.name},<br/> Phone: <a href="tel:0${response.provider.mobileno}">0${response.provider.mobileno}</a>,<br/> Office Address: ${response.provider_address}</p>`,
            icon: "success",
            button: "okay",
            closeOnEsc: false,
            closeOnClickOutside: false
