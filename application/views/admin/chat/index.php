                            ...
                            <ul role="tablist" class="left_message contacts">
                                ...
                                foreach ($chat_list as $key => $value) {
                                    ...
                                    if ($value['badge'] != 0) {
                                        ...
                                        $badge = "<span  class='position-absolute chat_color badge_col badge-pill bg-yellow-chat chat-bg-yellow'>" . $value['badge'] . "</span>";
                                       
                                    } else {
                                        $badge = "<span  class='position-absolute badge_col badge_chats  badge-theme '></span>";
                                    }
                                    ?>
            ...
            <div class="col-md-8 chat d-flex chat-scroll">
                ...
                <div class="card w-100 mb-0" id="history_page">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            <div class="img_cont">
                                <img  src="<?= $path; ?>" class="rounded-circle user_img" id="receiver_image">
                            </div>
                            <div class="user_info">
