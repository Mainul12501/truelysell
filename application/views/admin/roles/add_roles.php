					...
					<div class="card-body">
						<form id="add_roles" action="<?php echo $base_url; ?>admin/add-roles-permissions" method="post" autocomplete="off" enctype="multipart/form-data">
								...
								<?php foreach ($lang_test as $langval) { ?>
									<div class="col-md-6">
										<div class="form-group">
											<label><?php echo(!empty($categories['lg_admin_role_name']))?($categories['lg_admin_role_name']) : 'Role Name';  ?> <strong>(<?php echo $langval->language; ?>)</strong> <span class="text-danger">*</span></label>
							...
							<div class="service-fields-btns mt-0">
								<button class="btn btn-primary mr-2" name="form_submit" value="submit" type="submit"><?php echo(!empty($categories['lg_submit']))?($categories['lg_submit']) : 'Submit';  ?></button>
