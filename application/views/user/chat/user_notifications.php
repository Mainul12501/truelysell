                ...
                <div class="dashboradsec">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a id="not_del_all"data-id="" class='btn btn-sm bg-danger-light'></i>
                                <?php echo (!empty($user_language[$user_selected]['lg_delete_all'])) ? $user_language[$user_selected]['lg_delete_all'] : ($default_language['en']['lg_delete_all']??"Delete All"); ?>                            
                            </a>
                        </div>
                        <?php } ?>
                    </div>
                    <div class="notcenter" id="dataListnotify">
                        ...
                        if (!empty($notification_list)) {
                            foreach ($notification_list as $key => $value) {
                                ...
                                ?>
                                            ...
                                            <div class="noti-contents">
                                             ...
                                             <a class='text-danger' id="not_del"data-id="<?php  echo $value['notification_id']; ?>"><i class='far fa-trash-alt mr-1' ></i> </a>
                                        </div>
                                    </div>
                                </div>
                              <?php }
                            ...
                            <div class="notificationlist">
                                <p class="text-center text-danger mt-3"><?php echo (!empty($user_language[$user_selected]['lg_notification_empty'])) ? $user_language[$user_selected]['lg_notification_empty'] : $default_language['en']['lg_notification_empty']; ?>
                                </p>
                            </div>
                      <?php } ?>
                    </div>
