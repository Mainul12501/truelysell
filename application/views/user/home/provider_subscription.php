        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                if (!empty($my_subscribe['expiry_date_time'])) {
                    ...
                    $before_days = date('Y-m-d H:i:s', strtotime('-10 days', strtotime($my_subscribe['expiry_date_time'])));
                    $start = strtotime(date('Y-m-d'));
                    $end = strtotime($my_subscribe['expiry_date_time']);
                    $days = ceil(abs($end - $start) / 86400);

                    if (date('Y-m-d H:i:s') >= $before_days && date('Y-m-d H:i:s') <= $my_subscribe['expiry_date_time']) {
                ?>
                                ...
                                <p>
                                    <?php if(!empty($my_subscribe['expiry_date_time'])){
                                     ...
                                     ?>
                                        ...
                                        <span class="text-muted"><?php echo (!empty($user_language[$user_selected]['lg_your_subscription_expires_on'])) ? $user_language[$user_selected]['lg_your_subscription_expires_on'] : $default_language['en']['lg_your_subscription_expires_on']; ?></span> <?= $exp_dates; ?> </p>
                            <?php } else { ?>
                ...
                <?php if (!empty($subscription)) { ?>
                    ...
                    if (empty($my_subscribe) || !empty($datas) && $datas['fee'] == 0 && date('Y-m-d', strtotime($my_subscribe['expiry_date_time']) >= date('Y-m-d'))) {
                        ...
                        foreach ($subscription as $kval=>$list) { ?>
                        ...
                        <div id="subs_id_<?php echo $kval; ?>"class="col-xl-4 col-md-6 <?php echo $class; ?>">
                            <div class="card">
                                <div class="card-body">
                                    <div class="pricing-header">
                                        ...
                                        <input type="hidden" name="subs_id" value="<?php  echo $kval; ?>" id="subs_id">
                                    ...
                                    <?php } if(!empty($midtrans_option_status)) { ?>
                                             ...
                                             <input class="form-check-input" type="radio" name="payment_type" id="midtrans"  value="midtrans">
                                                <img  width="48" height="20" src="<?php echo base_url() . "assets/img/midtrans.png"; ?>">
                                             </div>
                                ...
                                <form method="POST" action="<?php echo base_url('subscription_paypal_braintree/').$list["id"]?>" id="myForm-<?php echo $kval ?>">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<input type='hidden' name='business' value="<?php echo $user_details['email']; ?>">
                                <input type="hidden" name="payload_nonce" value="" id="payload_nonce-<?php echo $kval ?>">  
                                <input type="hidden" name="orderID" value="" id="orderID-<?php echo $kval ?>">  
								<input type='hidden' name='item_name' value='<?php echo $list['subscription_name'] ?>'> 
                                <input type='hidden' name='sub_amount' value='<?php echo $list['fee'] ?>'> 

								<input type='hidden' name='item_number' value="123456"> 
                                <input type='hidden' name='sub_id' id="sub_id" value='<?php echo $list["id"] ?>'> 
                            ...
                            <input type="hidden" id="paypal_gateway" value="<?php echo $paypal_gateway; ?>">
                                ...
                                <a id="pays">
                                    ...
                                    <div id="paypal-button-<?php echo $kval ?>"  class="paypal-button"></div>

                                </a>

                                    <?php } if (empty($subscription_name['subscription_name'])) { ?>

                                        <a href="javascript:void(0);" class="btn btn-primary btn-block callStripe" data-id="<?php echo $list['id']; ?>"  data-subid="<?php echo $kval;?>" data-currency="<?php echo $user_currency_code; ?>" data-curcon="<?php echo $service_amount; ?>" data-amount="<?php echo $service_amount; ?>" ><?php echo (!empty($user_language[$user_selected]['lg_Select_Plan'])) ? $user_language[$user_selected]['lg_Select_Plan'] : $default_language['en']['lg_Select_Plan']; ?></a>
                        ...
                        <div class="col-xl-4 col-md-6 <?php echo $class; ?>">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                    if ($list['id'] != $my_subscribe['subscription_id'] && $list['fee'] != 0 || $my_subscribe['expiry_date_time'] <= date('Y-m-d')) {
                                    ?>
                                    <div class="row m-2">
                                        <?php if(!empty($paypal_option_status)) { ?>
                                            <div class="col-6">
                                        ...
                                        <?php } 
                                        // if(!empty($paysolution_option_status)) {
                                        ?>
                                            <!-- <div class="col-6">
                                        ...
                                        <?php 
                                        // }  
                                        if(!empty($midtrans_option_status)) { ?>
                                            
                                            <div class="col-6">

                                                <input class="form-check-input" type="radio" name="payment_type" id="midtrans"  value="midtrans">
                                                <img width="70" height="20" src="<?php echo base_url() . "assets/img/midtrans.png"; ?>">
                                        ...
                                        ?>
                                             ...
                                             <!-- <div class="col-6">
                                             <input class="form-check-input" type="radio" name="payment_type" id="iyzico"  data-currency="<?php echo $user_currency_code; ?>"  value="iyzico">
                                             <img width="70" height="20" src="<?php echo base_url() . "assets/img/iyzico.png"; ?>">
                                             </div> -->
                                        <?php 
                                        // } 
                                            $query = $this->db->query("SELECT * FROM offline_payment");
                                ...
                                <a id="pays">
                                    ...
                                    <?php } if (empty($subscription_name['subscription_name'])) { ?>
                                        ...
                                        <?php /* ?>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-block callStripe" data-id="<?php echo $list['id']; ?>"  data-subid="<?php echo $kval;?>" data-curcon="<?php echo $list['fee']; ?>" data-amount="<?php echo $list['fee']; ?>" data-currency="<?php echo $list['currency_code']; ?>" ><?php echo (!empty($user_language[$user_selected]['lg_Select_Plan'])) ? $user_language[$user_selected]['lg_Select_Plan'] : $default_language['en']['lg_Select_Plan']; ?></a> 
                                        <?php */  ?>
...
<?php } ?>
            ...
            <!-- Paysolution Payment Form -->
                ...
                <form method="POST" action="https://www.thaiepay.com/epaylink/payment.aspx?lang=en" id="paysolution_subscription" target="_blank">
                    ...
                    <input type="hidden" name="text" value="subscription" />
                    ...
                    <input type="hidden" name="productdetail" value="subscription">
