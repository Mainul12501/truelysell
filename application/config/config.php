...
if (file_exists(APPPATH . 'config/install.php')) {
    // redirect(guess_base_url().'/install', 'refresh');
    // <h1>Please Click here to <a id="click" href="' . guess_base_url() . 'install' . '">install</a></h1><p>if not works please enter /install after your URL</p>
    echo '<script>window.location.href="'.guess_base_url().'install' . '";</script>';
    exit();
}
/*
|--------------------------------------------------------------------------
