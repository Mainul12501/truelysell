	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col">
					<h3 class="page-title">						
						<?php echo(!empty($add_blog['lg_admin_blog_categories']))?($add_blog['lg_admin_blog_categories']) : 'Blog Categories'; ?>
					</h3>
				</div>
					...
					<div class="row filter-row">
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<label><?php echo(!empty($add_blog['lg_admin_category']))?($add_blog['lg_admin_category']) : 'Category'; ?></label>
								<select class="form-control" name="category">
									<option value=""><?php echo(!empty($add_blog['lg_admin_select_category']))?($add_blog['lg_admin_select_category']) : 'Select category'; ?></option>
						...
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<label><?php echo(!empty($add_blog['lg_admin_from_date']))?($add_blog['lg_admin_from_date']) : 'From Date'; ?></label>
								<div class="cal-icon">
						...
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<label><?php echo(!empty($add_blog['lg_admin_to_date']))?($add_blog['lg_admin_to_date']) : 'To Date'; ?></label>
								<div class="cal-icon">
						...
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<button class="btn btn-primary btn-block" name="form_submit" value="submit" type="submit"><?php echo(!empty($add_blog['lg_admin_submit']))?($add_blog['lg_admin_submit']) : 'Submit'; ?></button>
							</div>
						</div>
					</div>
