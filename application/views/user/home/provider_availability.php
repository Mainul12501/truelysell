...
<div class="content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8"><h4 class="widget-title"><?php echo (!empty($user_language[$user_selected]['lg_Availability'])) ? $user_language[$user_selected]['lg_Availability'] : $default_language['en']['lg_Availability']; ?></h4>
                <div class="card">
                    <div class="card-body">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
          ...
          <div class="row">
            ...
            <table class="table table-borderless availability-table">
            <tbody>
            <?php
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm daysfromtime_check"  name="availability[0][from_time]">
            <?php echo from_time(1, $All_from_time); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm daystotime_check" name="availability[0][to_time]">
 ...
 $mon_to_time=$availability_details[0]['to_time'];
            ...
            <td class="">
            From time <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime1 select_from_time" data-id="1"  name="availability[1][from_time]" <?php echo $day_name[1]; ?>>
              
            <?php echo from_time(1, $var_from_time[1]); ?>
            </select></span>
            </td>
            <td class="">
            To time <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime1" name="availability[1][to_time]" <?php echo $day_name[1]; ?>>
            ...
            <td class="">
            From time <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime2 select_from_time" data-id="2" name="availability[2][from_time]" <?php echo $day_name[2]; ?>>
            ...
            <td class="">
            To time <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime2" name="availability[2][to_time]" <?php echo $day_name[2]; ?>>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime3 select_from_time" data-id="3"  name="availability[3][from_time]" <?php echo $day_name[3]; ?>>
            <?php echo from_time(1, $var_from_time[3]); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime3" name="availability[3][to_time]" <?php echo $day_name[3]; ?>>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime4 select_from_time" data-id="4" name="availability[4][from_time]" <?php echo $day_name[4]; ?>>
            <?php echo from_time(1, $var_from_time[4]); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime4" name="availability[4][to_time]" <?php echo $day_name[4]; ?>>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime5 select_from_time" data-id="5" name="availability[5][from_time]" <?php echo $day_name[5]; ?>>
            <?php echo from_time(1, $var_from_time[5]); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm  custom-height eachdaytotime eachdaytotime5" name="availability[5][to_time]" <?php echo $day_name[5]; ?>>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime6 select_from_time" data-id="6" name="availability[6][from_time]" <?php echo $day_name[6]; ?>>
            <?php echo from_time(1, $var_from_time[6]); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime6" name="availability[6][to_time]" <?php echo $day_name[6]; ?>>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdayfromtime eachdayfromtime7 select_from_time" data-id="7" name="availability[7][from_time]" <?php echo $day_name[7]; ?>>
            <?php echo from_time(1, $var_from_time[7]); ?>
            </select></span>
            </td>
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select ml-2">
            <select class="custom-select custom-select-sm eachdaytotime eachdaytotime7" name="availability[7][to_time]" <?php echo $day_name[7]; ?>>
