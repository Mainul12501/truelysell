            ...
            if (isset($phpmail_config) && !empty($phpmail_config)) {
                ...
                if ($phpmail_config == "sendgrid") {
                  ...
                  if ($send_mail == "TRUE") {
		            ...
		            $message = (!empty($this->user_language[$this->user_selected]['lg_email_sucess'])) ? $this->user_language[$this->user_selected]['lg_email_sucess'] : $this->default_language['en']['lg_email_sucess'];
