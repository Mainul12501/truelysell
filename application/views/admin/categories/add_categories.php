					...
					<div class="card-body">
						<form id="add_category" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group mb-3">
								...
								<input class="form-control" type="text"  name="category_slug" id="category_slug" placeholder="test-slug" required>
							</div>
							<div class="form-group mb-3">
							...
							<div class="form-group mt-4">
								<button class="btn btn-primary mr-2" name="form_submit" value="submit" type="submit"><?php echo(!empty($categories['lg_admin_add_category']))?($categories['lg_admin_add_category']) : 'Add Category';  ?></button>
