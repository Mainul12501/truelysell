					...
					<div class="widget">
						...
						<div class="row">
							...
							<div class="form-group col-xl-12">
								...
								<input type="text" class="form-control" name="address" value="<?php if(!empty($provider_address['address'])){ echo $provider_address['address']; }?>" maxlength="80">
							</div>
							<div class="form-group col-xl-6">
							...
							<div class="form-group col-xl-6">
								...
								<input type="text" class="form-control" name="pincode" value="<?php if(!empty($provider_address['pincode'])){echo $provider_address['pincode'];} ?>"  maxlength="12">
							</div>
							<div class="form-group col-xl-12">
