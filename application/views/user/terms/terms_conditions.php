				...
				<div class="breadcrumb-title">
					<?php 
                        foreach ($terms_language as $terms) { ?>
    						<h2><?php echo(!empty($terms['title']))?($terms['title']) : 'Terms and Condition';  ?></h2>
			...
			<div class="col-auto float-right ml-auto breadcrumb-menu">
				<nav aria-label="breadcrumb" class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<?php 
                        foreach ($terms_language as $terms) { ?>
    						<li class="breadcrumb-item active" aria-current="page"><?php echo(!empty($terms['title']))?($terms['title']) : 'Terms and Condition';  ?></li>
