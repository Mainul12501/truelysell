					...
					<div class="row">
						<div class="col">
							<h3 class="page-title">
								<?php 
								if($id!=0){
									echo(!empty($adminuser['lg_admin_edit_user']))?($adminuser['lg_admin_edit_user']) : 'Edit User';
								}
								else{
									echo(!empty($adminuser['lg_admin_add_user']))?($adminuser['lg_admin_add_user']) : 'Add User';
								}
								?>
							</h3>
						</div>
					...
					<div class="card-body">
						<form id="add_user" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label><?php echo(!empty($adminuser['lg_admin_name']))?($adminuser['lg_admin_name']) : 'Name';  ?> (<?php echo $langval->language; ?>) <span class="text-danger">*</span></label>
								<input class="form-control" type="text"  name="name_<?php echo $langval->id; ?>" id="name" value="<?php echo (!empty($user['name']))?$user['name']:''?>" required>
							</div>
							<?php }  ?>
							<div class="form-group">
								<?php 
								...
								<label><?php echo(!empty($adminuser['lg_admin_mobile_number']))?($adminuser['lg_admin_mobile_number']) : 'Mobile Number';  ?> <span class="text-danger">*</span></label><br>
							...
							<div class="form-group">
								<label><?php echo(!empty($adminuser['lg_admin_email']))?($adminuser['lg_admin_email']) : 'Email';  ?><span class="text-danger">*</span></label>
							...
							<div class="form-group">
								<label><?php echo(!empty($adminuser['lg_admin_status']))?($adminuser['lg_admin_status']) : 'Status';  ?><span class="text-danger">*</span></label>
								&nbsp;
