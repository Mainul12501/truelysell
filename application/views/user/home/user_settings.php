							...
							<form id="update_user" action="<?php echo base_url()?>user/dashboard/update_user" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="form-group col-xl-6">
										<label class="mr-sm-2"><?php echo (!empty($user_language[$user_selected]['lg_Name'])) ? $user_language[$user_selected]['lg_Name'] : ($default_language['en']['lg_Name']??"Name"); ?></label>
										<input class="form-control" type="text" value="<?php echo $get_details['name']?>" readonly>
									</div>
									<div class="form-group col-xl-6">
										<label class="mr-sm-2"><?php echo (!empty($user_language[$user_selected]['lg_Email'])) ? $user_language[$user_selected]['lg_Email'] : ($default_language['en']['lg_Email']??"Email"); ?></label>
										<input class="form-control" type="email" value="<?php echo $get_details['email']?>" readonly>
									</div>
									<div class="form-group col-xl-6">
										<label class="mr-sm-2"><?php echo (!empty($user_language[$user_selected]['lg_Country_Code'])) ? $user_language[$user_selected]['lg_Country_Code'] : ($default_language['en']['lg_Country_Code']??"Country Code"); ?></label>
										<input class="form-control" type="text" value="<?php echo "+".$get_details['country_code']?>" readonly>
									</div>
									<div class="form-group col-xl-6">
										<label class="mr-sm-2"><?php echo (!empty($user_language[$user_selected]['lg_Mobile_Number'])) ? $user_language[$user_selected]['lg_Mobile_Number'] : ($default_language['en']['lg_Mobile_Number']??"Mobile No"); ?></label>
										<input class="form-control no_only" type="text"  value="<?php echo $get_details['mobileno']?>" name="mobileno" readonly required>
									</div>
									<div class="form-group col-xl-6">
										<label class="mr-sm-2"><?php echo (!empty($user_language[$user_selected]['lg_Date_birth'])) ? $user_language[$user_selected]['lg_Date_birth'] : ($default_language['en']['lg_Date_birth']??"D.O.B"); ?></label>
									...
									<div class="form-group col-xl-6">
										...
										<input type="text" class="form-control" name="pincode" value="<?php if(!empty($user_address['pincode'])){echo $user_address['pincode'];} ?>" maxlength="6">
									</div>	
									<div class="form-group col-xl-12">
