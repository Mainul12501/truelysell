                            ...
                            <div class="card w-100 mb-0" id="history_page">
                                ...
                                <div class="card-header msg_head">
                                    <div class="d-flex bd-highlight">
                                        ...
                                        <div>
                                            <a href="#" class="btn btn-sm bg-light mr-2 chat-options-dot" data-id="<?php echo $lang->language_value; ?>"> <i class="fas fa-ellipsis-h"></i>
                                            <div class="options_chat" id="options-menu-chat">
                                                <a href="#" id="delete-options" class="delete-option">Delete</a>
                                            </div>
                                        </div>
